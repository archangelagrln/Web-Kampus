...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <br>
    <br><br><br><br>
<br> <h2 style="margin-left:340px;color:white;-webkit-text-stroke: 0.9px white">LECTURER UNIVERSITY OF TORONTO</h2><br><br>
...
function cari($keyword){
    global $connect;
    $query = "SELECT * FROM dosen WHERE nama LIKE '%$keyword%' OR iddosen LIKE '%$keyword%' OR matkul LIKE '%$keyword%' OR fakultas LIKE '%$keyword' ";
