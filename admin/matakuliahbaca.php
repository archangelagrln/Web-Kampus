...
<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <br>
    <br>
<br> <h2 style="margin-left:400px;color:white;-webkit-text-stroke: 0.8px white">MATA KULIAH SISTEM INFORMASI</h2><br><br>
...
function cari($keyword){
    global $connect;
    $query = "SELECT * FROM matkulinput WHERE kodemk LIKE '%$keyword%' OR matakuliah LIKE '%$keyword%' OR sks LIKE '%$keyword%'";
...
if(isset($_POST["cari"])){
    ...
    $result = mysqli_query($connect,"SELECT * FROM matkulinput");
}
    ...
    <tbody>
        ...
        {?>
            ...
            <tr>
                ...
                <td scope="row"><?=$data['kodemk']; ?></td>
                <td scope="row"><?=$data['matakuliah']; ?></td>
                <td scope="row"><?=$data['sks']; ?></td>
