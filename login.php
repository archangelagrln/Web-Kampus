    ...
    <div class="container-form">
      <form class="form1login" action="proseslogin.php" method="POST">
        <div class="mysterylogin">
          <h5 style="font-family: times new roman; margin-left: 3px; margin-bottom: 20px;margin-top: 60px color: black; border: white; -webkit-text-stroke: 1.4px black"><br>
            <img src="image/icons8-login-64.png" alt="kuncilogo" width="40px"> Mystery Login
          </h5>
        </div>
        <div class="row mb-3">
       ...
       <div class="register" style="margin-left: 40px">
        <p style="color: white">Do not have account? <a href="formregister.php" style="color : #0000CD">Register</a></p>
